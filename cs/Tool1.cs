...
namespace cs
{
    ...
    /// </summary>
    [Guid("e48bf82a-3fc3-4a40-97e6-f52ae07f0de3")]
    ...
    public sealed class Tool1 : BaseTool
    {
        ...
        public override void OnMouseUp(int Button, int Shift, int X, int Y)
        {
            ...
            if (pSelectionTracker != null)
            {
                ...
                m_hookHelper.ActiveView.PartialRefresh(esriViewDrawPhase.esriViewGraphicSelection, null, pElement.Geometry.Envelope);
            }
        }
        #endregion
    }
